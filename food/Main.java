...
public class Main {
    public static void main(String[] args) {
        ...
        while(choice != 7) {
            ...
            System.out.println("3. Search Order Details");
            System.out.println("4. View Sorted Order IDs");
            System.out.println("5. Check Revenue by Zone Range");
            System.out.println("6. Calculate Shortest Delivery Route");
